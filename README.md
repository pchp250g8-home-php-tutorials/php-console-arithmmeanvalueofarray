A console application project written in C# and implemented in the Microsoft Visual Studio Code Editor. PHP Script. Simple input/output. Working with arrays and random numbers. Calculating the arithmetic mean of array elements.
